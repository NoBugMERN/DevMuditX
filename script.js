...
let songs = [
    {songName : "Warriyo- Mortals (feat. Laura Brehe)[NCS Release]" , filePath : "songs/1.mp3" , coverPath : "covers/1.jpg"},
    {songName : "Cielo - Huma -Huma" , filePath : "songs/2.mp3" , coverPath : "covers/2.jpg"},
    {songName : "Deaf" , filePath : "songs/3.mp3" , coverPath : "covers/3.jpg"},
    {songName : "Different Heaven & EHDE - My Heart" , filePath : "songs/4.mp3" , coverPath : "covers/4.jpg"},
    ...
    {songName : "Sajana" , filePath : "songs/9.mp3" , coverPath : "covers/9.jpg"},
...
masterPlay.addEventListener('click',()=>{
    ...
    if(audioElement.paused || audioElement.currentTime<=0){
        audioElement.play().then(()=>{
            ...
            console.log("Audio unable to play",err);
        })
    }else{
        audioElement.pause();
